...
- Always generate the Github Action pipeline in the `.github/workflows` directory to verify the code.
...
- All REST APIs should be exposed with the `${{ values.apiPath }}` prefix.
