...
@ActiveProfiles("test")
class DgfipConnectorServiceITTest {

    @Autowired
    private DgfipConnectorService service;
    ...
    void shouldReturnIncome() {
        ...
        assertThat(income.annualIncome())
    ...
    void shouldReturnTaxNotice() {
        ...
        assertThat(taxNotice.referenceNumber())
                .startsWith("AV-");
    }
    ...
    void shouldThrowServerException() {
        ...
        assertThatThrownBy(() -> service.getIncome("500"))
    ...
    void shouldFailOnInvalidJson() {
        ...
        assertThatThrownBy(() -> service.getIncome("INVALID_JSON"))
