...
public final class CitizenJpaMapper {
  ...
  public static Citizen toDomain(CitizenJpaEntity entity) {
    ...
    return new Citizen(
        ...
        entity.getLastName(),
        new Address(
            entity.getStreet(), entity.getPostalCode(), entity.getCity(), entity.getCountry()),
        new Household(
            entity.getHousingStatus(), entity.getChildrenCount(), entity.getSingleParent()));
  }
  ...
  public static CitizenJpaEntity toEntity(Citizen citizen) {
    ...
    return CitizenJpaEntity.builder()
        ...
        .housingStatus(citizen.getHousehold().housingStatus())
