...
public class LeaseCompletedListener {
    ...
    public void consume(
        ...
        if (!idempotencyService.tryAcquire(
            ...
            log.info(
                    "Lease event already processed or being processed " +
                            "documentId={} eventId={}",
                    metadata.getDocumentId(),
                    eventId);
        ...
        try {
            ...
            UpdateProfileCommand profileCommand = LeaseMapper.toCommand(event);
            ...
            log.error(
                    "Lease extraction processing failed " +
                            "documentId={} eventId={}",
                    metadata.getDocumentId(),
                    eventId,
                    e);
