...
public class DocumentController {
  ...
  public List<DocumentDto> getDocuments(@AuthenticationPrincipal Jwt jwt) {
    ...
    return documentService.getDocuments(jwt.getSubject());
  }

  @GetMapping("/summary")
  public DocumentSummaryDto getSummary(@AuthenticationPrincipal Jwt jwt) {

    return documentService.getSummary(jwt.getSubject());
  }
  ...
  public ResponseEntity<Void> delete(@PathVariable("id") Long id, @AuthenticationPrincipal Jwt jwt)
    ...
    documentService.delete(id, jwt.getSubject());
  ...
  public ResponseEntity<Resource> download(
      @PathVariable("id") Long id, @AuthenticationPrincipal Jwt jwt) throws AccessDeniedException {

    DownloadedDocument document = documentService.download(id, jwt.getSubject());
